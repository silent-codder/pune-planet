...
public class ForYouFavDocAdapter extends RecyclerView.Adapter<ForYouFavDocAdapter.ViewHolder> {
    ...
    public ForYouFavDocAdapter(List<UploadDocData> uploadDocData) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.for_you_fav_doc_view,parent,false);
