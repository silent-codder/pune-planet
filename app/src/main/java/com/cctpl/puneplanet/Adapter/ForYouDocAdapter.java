...
public class ForYouDocAdapter extends RecyclerView.Adapter<ForYouDocAdapter.ViewHolder> {
    ...
    public ForYouDocAdapter(List<UploadDocData> uploadDocData) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.for_you_doc_view,parent,false);
